			...
			// if(tabIndex==0){ 
				$.each (varSelected, function(i,itm){
					...
					if(i==0){
						...
						addChart_VSNR(dStr,getSelectedTabIndex(), $(this).attr('name'), 'ts_vsnr_det_'+itm);
						
						var radianceHTML =  getDraggableContainerHTML('rad_det_', 'Residual Average',itm);
						$('#chartContainer').append(radianceHTML);
						addChart_VRadiance(dStr,getSelectedTabIndex(), $(this).attr('name'), 'ts_rad_det_'+itm);
					}
 ...
 */		    
			...
			$("#checkboxes :checkbox").change(function(e){
				if ($(this).is(":checked")){
					...
					$('#chartContainer').append(vsnrHTML);
					addChart_VSNR('2018-04-05',getSelectedTabIndex(), $(this).attr('name'), 'ts_vsnr_det_'+$(this).attr('name'));
					
					var radianceHTML =  getDraggableContainerHTML('rad_det_', 'Residual Average',$(this).attr('name'));
					$('#chartContainer').append(radianceHTML);
					addChart_VRadiance('2018-04-05',getSelectedTabIndex(), $(this).attr('name'), 'ts_rad_det_'+$(this).attr('name'));
