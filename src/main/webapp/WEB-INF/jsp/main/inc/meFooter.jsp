 ...
 <link rel="stylesheet" href="${pageContext.request.contextPath}/css/footer.css">
    ...
    <footer role="contentinfo" id="solstice-footer">
      ...
      <div class="container">
          <div id="copyright"> 
            <div class="container">
              	 <img src="${pageContext.request.contextPath}/resource/assets/ci/footer_kma_kr_en.png" alt="kma.go.kr logo" width="160" id="logo-kma-white"/>
	             <div style="float: left;padding-left: 10px; padding-top: 5px;">
	              	 <div>Copyright &copy; 2016 NMSC. All Rights Reserved.</div>
